    ...
    <header className="sticky top-0 z-50 bg-white/70 backdrop-blur-xl border-b border-gray-200 backdrop-saturate-150">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-4">
        <div className="flex items-center justify-between">
          ...
          >
            <h1 className="text-xl font-black font-chivo tracking-tighter">
              🚀 Interview Prep
            </h1>
          </div>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                ...
                <div className="px-2 py-1.5">
                  <p className="text-sm font-medium font-ibm-plex-sans">
                    👋 {user?.name}
                  </p>
                  <p className="text-xs text-gray-500 font-ibm-plex-sans">
                    📧 {user?.email}
                  </p>
                </div>
